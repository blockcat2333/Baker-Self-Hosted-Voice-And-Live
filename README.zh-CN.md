...
- 稳定服务端发布使用纯数字版本号，例如 `1.1.1`；服务端 beta 发布可以使用 `1.1.1beta.1` 这样的紧凑标签。对应 Docker 镜像为 `blockcat233/baker:<版本号>`。
...
如果你想始终跟随最新滚动版本，也可以把 `1.1.1` 换成 `latest`。
