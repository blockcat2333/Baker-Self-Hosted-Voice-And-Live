...
- 服务端发布使用纯数字版本号，例如 `1.0.7`，Docker 镜像为 `blockcat233/baker:1.0.7`。
- 客户端发布标签使用服务端版本号加一个字母，从 `a` 开始，例如 `1.0.7a`、`1.0.7b`。
...
如果你想始终跟随最新滚动版本，也可以把 `1.0.7` 换成 `latest`。
