...
- Server releases use numeric tags such as `1.0.8` and Docker images such as `blockcat233/baker:1.0.8`.
- Client release labels follow the server version plus a letter, starting at `a`: `1.0.8a`, `1.0.8b`, and so on.
...
If you want to follow the newest rolling image instead of pinning this release, replace `1.0.8` with `latest`.
